...
public interface MethodGenerator {
   ...
   * com.datastax.oss.driver.api.core.cql.reactive.ReactiveResultSet} and {@link
   * com.datastax.oss.driver.api.mapper.reactive.MappedReactiveResultSet} should return true here.
   */
