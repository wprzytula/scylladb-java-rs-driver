...
public class VersionRequirementTest {
  ...
  private static BackendType HCD = BackendType.HCD;
  ...
  private static VersionRequirement HCD_ANY = new VersionRequirement(HCD, "", "", "");
  ...
  public void empty_requirements() {
    ...
    assertThat(VersionRequirement.meetsAny(req, HCD, V_0_0_0)).isTrue();
    assertThat(VersionRequirement.meetsAny(req, HCD, V_1_0_0)).isTrue();
  }

  @Test
  public void single_requirement_any_version() {
    List<VersionRequirement> anyCassandra = Collections.singletonList(CASSANDRA_ANY);
    List<VersionRequirement> anyHcd = Collections.singletonList(HCD_ANY);
    ...
    assertThat(VersionRequirement.meetsAny(anyHcd, HCD, V_0_0_0)).isTrue();
    assertThat(VersionRequirement.meetsAny(anyHcd, HCD, V_1_0_0)).isTrue();

    assertThat(VersionRequirement.meetsAny(anyHcd, CASSANDRA, V_0_0_0)).isFalse();
    assertThat(VersionRequirement.meetsAny(anyHcd, CASSANDRA, V_1_0_0)).isFalse();
    assertThat(VersionRequirement.meetsAny(anyCassandra, HCD, V_0_0_0)).isFalse();
    assertThat(VersionRequirement.meetsAny(anyCassandra, HCD, V_1_0_0)).isFalse();
  }
  ...
  public void single_requirement_min_only() {
    ...
    assertThat(VersionRequirement.meetsAny(req, HCD, V_1_0_0)).isFalse();
  ...
  public void single_requirement_max_only() {
    ...
    assertThat(VersionRequirement.meetsAny(req, HCD, V_0_0_0)).isFalse();
  ...
  public void multi_requirement_any_version() {
    List<VersionRequirement> req = ImmutableList.of(CASSANDRA_ANY, HCD_ANY);
  ...
  public void multi_db_requirement_min_one_any_other() {
    List<VersionRequirement> req = ImmutableList.of(CASSANDRA_FROM_1_0_0, HCD_ANY);
