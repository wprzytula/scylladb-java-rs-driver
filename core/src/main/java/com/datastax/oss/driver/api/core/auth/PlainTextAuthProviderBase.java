...
public abstract class PlainTextAuthProviderBase implements AuthProvider {
  ...
  public static class Credentials {
     ...
     *
     * <p>Proxy authentication was a DataStax Enterprise feature; against Apache Cassandra or
     * ScyllaDB, the authorizationId is ignored.
     */
    public Credentials(
  ...
  protected static class PlainTextAuthenticator implements SyncAuthenticator {
    ...
    /**
     * Returns a byte buffer containing the required SASL mechanism.
     *
