...
/** Built-in implementation of the protocol version registry, supports all Cassandra versions. */
@ThreadSafe
public class DefaultProtocolVersionRegistry implements ProtocolVersionRegistry {
  ...
  // Removes all versions strictly higher than the given version from candidates.
  private void removeHigherThan(
      DefaultProtocolVersion maxOssVersion, Set<ProtocolVersion> candidates) {
