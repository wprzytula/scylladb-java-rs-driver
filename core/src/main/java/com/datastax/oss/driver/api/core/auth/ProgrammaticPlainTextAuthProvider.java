...
public class ProgrammaticPlainTextAuthProvider extends PlainTextAuthProviderBase {
   ...
   * the authorizationId is ignored. Use {@link #ProgrammaticPlainTextAuthProvider(String, String)}
   * instead, or set the authorizationId to an empty string.
   */
   ...
   *
   * <p>Proxy authentication was a DataStax Enterprise feature and is not supported by this driver:
   * the authorizationId is ignored and this method should not be used.
   *
